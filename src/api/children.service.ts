...
export class ChildrenService {
     ...
     */
    public getChildCustomContent(id: number, cursor?: string, limit?: number, sort?: Array<ChildCustomContentSortOrder>, getChildCustomContentOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultChildCustomContent>>;
    public getChildCustomContent(id: number, cursor?: string, limit?: number, sort?: Array<ChildCustomContentSortOrder>, getChildCustomContentOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getChildCustomContent.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultChildCustomContent>(`${this.basePath}/custom-content/${encodeURIComponent(String(id))}/children`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getChildCustomContentOpts?.config,
                        headers: {...headers, ...getChildCustomContentOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getChildPages(id: number, cursor?: string, limit?: number, sort?: Array<ChildPageSortOrder>, getChildPagesOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultChildPage>>;
    public getChildPages(id: number, cursor?: string, limit?: number, sort?: Array<ChildPageSortOrder>, getChildPagesOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getChildPages.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultChildPage>(`${this.basePath}/pages/${encodeURIComponent(String(id))}/children`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public getDatabaseDirectChildren(id: number, cursor?: string, limit?: number, sort?: Array<ContentSortOrder>, getDatabaseDirectChildrenOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultChildrenResponse>>;
    public getDatabaseDirectChildren(id: number, cursor?: string, limit?: number, sort?: Array<ContentSortOrder>, getDatabaseDirectChildrenOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getDatabaseDirectChildren.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultChildrenResponse>(`${this.basePath}/databases/${encodeURIComponent(String(id))}/direct-children`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getDatabaseDirectChildrenOpts?.config,
                        headers: {...headers, ...getDatabaseDirectChildrenOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getFolderDirectChildren(id: number, cursor?: string, limit?: number, sort?: Array<ContentSortOrder>, getFolderDirectChildrenOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultChildrenResponse>>;
    public getFolderDirectChildren(id: number, cursor?: string, limit?: number, sort?: Array<ContentSortOrder>, getFolderDirectChildrenOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getFolderDirectChildren.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultChildrenResponse>(`${this.basePath}/folders/${encodeURIComponent(String(id))}/direct-children`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getFolderDirectChildrenOpts?.config,
                        headers: {...headers, ...getFolderDirectChildrenOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getPageDirectChildren(id: number, cursor?: string, limit?: number, sort?: Array<ContentSortOrder>, getPageDirectChildrenOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultChildrenResponse>>;
    public getPageDirectChildren(id: number, cursor?: string, limit?: number, sort?: Array<ContentSortOrder>, getPageDirectChildrenOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getPageDirectChildren.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultChildrenResponse>(`${this.basePath}/pages/${encodeURIComponent(String(id))}/direct-children`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getPageDirectChildrenOpts?.config,
                        headers: {...headers, ...getPageDirectChildrenOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getSmartLinkDirectChildren(id: number, cursor?: string, limit?: number, sort?: Array<ContentSortOrder>, getSmartLinkDirectChildrenOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultChildrenResponse>>;
    public getSmartLinkDirectChildren(id: number, cursor?: string, limit?: number, sort?: Array<ContentSortOrder>, getSmartLinkDirectChildrenOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getSmartLinkDirectChildren.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultChildrenResponse>(`${this.basePath}/embeds/${encodeURIComponent(String(id))}/direct-children`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getSmartLinkDirectChildrenOpts?.config,
                        headers: {...headers, ...getSmartLinkDirectChildrenOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getWhiteboardDirectChildren(id: number, cursor?: string, limit?: number, sort?: Array<ContentSortOrder>, getWhiteboardDirectChildrenOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultChildrenResponse>>;
    public getWhiteboardDirectChildren(id: number, cursor?: string, limit?: number, sort?: Array<ContentSortOrder>, getWhiteboardDirectChildrenOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getWhiteboardDirectChildren.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultChildrenResponse>(`${this.basePath}/whiteboards/${encodeURIComponent(String(id))}/direct-children`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getWhiteboardDirectChildrenOpts?.config,
                        headers: {...headers, ...getWhiteboardDirectChildrenOpts?.config?.headers},
                    }
                );
            })
        );
