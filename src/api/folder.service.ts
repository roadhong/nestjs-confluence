...
export class FolderService {
            ...
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<CreateFolder200Response>(`${this.basePath}/folders`,
                    createFolderRequest,
                    {
                        ...
                        headers: {...headers, ...createFolderOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [deleteFolderOpts.config] Override http request option.
     */
    public deleteFolder(id: number, deleteFolderOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public deleteFolder(id: number, deleteFolderOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.delete<any>(`${this.basePath}/folders/${encodeURIComponent(String(id))}`,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...deleteFolderOpts?.config,
                        headers: {...headers, ...deleteFolderOpts?.config?.headers},
                    }
                );
            })
        );
    ...
    public getFolderById(id: number, includeCollaborators?: boolean, includeDirectChildren?: boolean, includeOperations?: boolean, includeProperties?: boolean, getFolderByIdOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<CreateFolder200Response>(`${this.basePath}/folders/${encodeURIComponent(String(id))}`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getFolderByIdOpts?.config,
                        headers: {...headers, ...getFolderByIdOpts?.config?.headers},
                    }
                );
            })
        );
