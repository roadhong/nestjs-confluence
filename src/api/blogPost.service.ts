...
export class BlogPostService {
     ...
     */
    public createBlogPost(CreateBlogPostRequest: CreateBlogPostRequest, _private?: boolean, createBlogPostOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CreateBlogPost200Response>>;
    public createBlogPost(CreateBlogPostRequest: CreateBlogPostRequest, _private?: boolean, createBlogPostOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<CreateBlogPost200Response>(`${this.basePath}/blogposts`,
     ...
     */
    public deleteBlogPost(id: number, purge?: boolean, draft?: boolean, deleteBlogPostOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public deleteBlogPost(id: number, purge?: boolean, draft?: boolean, deleteBlogPostOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.delete<any>(`${this.basePath}/blogposts/${encodeURIComponent(String(id))}`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public getBlogPostById(id: number, body_format?: PrimaryBodyRepresentationSingle, get_draft?: boolean, status?: Array<'current' | 'trashed' | 'deleted' | 'historical' | 'draft'>, version?: number, include_labels?: boolean, include_properties?: boolean, include_operations?: boolean, include_likes?: boolean, include_versions?: boolean, include_version?: boolean, include_favorited_by_current_user_status?: boolean, include_webresources?: boolean, include_collaborators?: boolean, getBlogPostByIdOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CreateBlogPost200Response>>;
    public getBlogPostById(id: number, body_format?: PrimaryBodyRepresentationSingle, get_draft?: boolean, status?: Array<'current' | 'trashed' | 'deleted' | 'historical' | 'draft'>, version?: number, include_labels?: boolean, include_properties?: boolean, include_operations?: boolean, include_likes?: boolean, include_versions?: boolean, include_version?: boolean, include_favorited_by_current_user_status?: boolean, include_webresources?: boolean, include_collaborators?: boolean, getBlogPostByIdOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<CreateBlogPost200Response>(`${this.basePath}/blogposts/${encodeURIComponent(String(id))}`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public getBlogPosts(id?: Array<number>, space_id?: Array<number>, sort?: BlogPostSortOrder, status?: Array<'current' | 'deleted' | 'trashed'>, title?: string, body_format?: PrimaryBodyRepresentation, cursor?: string, limit?: number, getBlogPostsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultBlogPost>>;
    public getBlogPosts(id?: Array<number>, space_id?: Array<number>, sort?: BlogPostSortOrder, status?: Array<'current' | 'deleted' | 'trashed'>, title?: string, body_format?: PrimaryBodyRepresentation, cursor?: string, limit?: number, getBlogPostsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        let queryParameters = new URLSearchParams();
        if (id) {
            id.forEach((element) => {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultBlogPost>(`${this.basePath}/blogposts`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public getBlogPostsInSpace(id: number, sort?: BlogPostSortOrder, status?: Array<'current' | 'deleted' | 'trashed'>, title?: string, body_format?: PrimaryBodyRepresentation, cursor?: string, limit?: number, getBlogPostsInSpaceOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultBlogPost>>;
    public getBlogPostsInSpace(id: number, sort?: BlogPostSortOrder, status?: Array<'current' | 'deleted' | 'trashed'>, title?: string, body_format?: PrimaryBodyRepresentation, cursor?: string, limit?: number, getBlogPostsInSpaceOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getBlogPostsInSpace.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultBlogPost>(`${this.basePath}/spaces/${encodeURIComponent(String(id))}/blogposts`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getBlogPostsInSpaceOpts?.config,
                        headers: {...headers, ...getBlogPostsInSpaceOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getLabelBlogPosts(id: number, space_id?: Array<number>, body_format?: PrimaryBodyRepresentation, sort?: BlogPostSortOrder, cursor?: string, limit?: number, getLabelBlogPostsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultBlogPost>>;
    public getLabelBlogPosts(id: number, space_id?: Array<number>, body_format?: PrimaryBodyRepresentation, sort?: BlogPostSortOrder, cursor?: string, limit?: number, getLabelBlogPostsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getLabelBlogPosts.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultBlogPost>(`${this.basePath}/labels/${encodeURIComponent(String(id))}/blogposts`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public updateBlogPost(id: number, UpdateBlogPostRequest: UpdateBlogPostRequest, updateBlogPostOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CreateBlogPost200Response>>;
    public updateBlogPost(id: number, UpdateBlogPostRequest: UpdateBlogPostRequest, updateBlogPostOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.put<CreateBlogPost200Response>(`${this.basePath}/blogposts/${encodeURIComponent(String(id))}`,
