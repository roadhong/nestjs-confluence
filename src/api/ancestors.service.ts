...
export class AncestorsService {
     ...
     */
    public getDatabaseAncestors(id: number, limit?: number, getDatabaseAncestorsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultAncestor>>;
    public getDatabaseAncestors(id: number, limit?: number, getDatabaseAncestorsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getDatabaseAncestors.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultAncestor>(`${this.basePath}/databases/${encodeURIComponent(String(id))}/ancestors`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getDatabaseAncestorsOpts?.config,
                        headers: {...headers, ...getDatabaseAncestorsOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getFolderAncestors(id: number, limit?: number, getFolderAncestorsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultAncestor>>;
    public getFolderAncestors(id: number, limit?: number, getFolderAncestorsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getFolderAncestors.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultAncestor>(`${this.basePath}/folders/${encodeURIComponent(String(id))}/ancestors`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public getPageAncestors(id: number, limit?: number, getPageAncestorsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultAncestor1>>;
    public getPageAncestors(id: number, limit?: number, getPageAncestorsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getPageAncestors.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultAncestor1>(`${this.basePath}/pages/${encodeURIComponent(String(id))}/ancestors`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public getSmartLinkAncestors(id: number, limit?: number, getSmartLinkAncestorsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultAncestor>>;
    public getSmartLinkAncestors(id: number, limit?: number, getSmartLinkAncestorsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getSmartLinkAncestors.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultAncestor>(`${this.basePath}/embeds/${encodeURIComponent(String(id))}/ancestors`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getSmartLinkAncestorsOpts?.config,
                        headers: {...headers, ...getSmartLinkAncestorsOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getWhiteboardAncestors(id: number, limit?: number, getWhiteboardAncestorsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultAncestor>>;
    public getWhiteboardAncestors(id: number, limit?: number, getWhiteboardAncestorsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getWhiteboardAncestors.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultAncestor>(`${this.basePath}/whiteboards/${encodeURIComponent(String(id))}/ancestors`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getWhiteboardAncestorsOpts?.config,
                        headers: {...headers, ...getWhiteboardAncestorsOpts?.config?.headers},
                    }
                );
            })
        );
