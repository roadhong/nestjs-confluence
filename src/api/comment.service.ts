...
export class CommentService {
     ...
     */
    public createFooterComment(CreateFooterCommentModel: CreateFooterCommentModel, createFooterCommentOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CreateFooterComment201Response>>;
    public createFooterComment(CreateFooterCommentModel: CreateFooterCommentModel, createFooterCommentOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (CreateFooterCommentModel === null || CreateFooterCommentModel === undefined) {
            throw new Error('Required parameter CreateFooterCommentModel was null or undefined when calling createFooterComment.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<CreateFooterComment201Response>(`${this.basePath}/footer-comments`,
                    CreateFooterCommentModel,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...createFooterCommentOpts?.config,
                        headers: {...headers, ...createFooterCommentOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public createInlineComment(CreateInlineCommentModel: CreateInlineCommentModel, createInlineCommentOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CreateInlineComment201Response>>;
    public createInlineComment(CreateInlineCommentModel: CreateInlineCommentModel, createInlineCommentOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (CreateInlineCommentModel === null || CreateInlineCommentModel === undefined) {
            throw new Error('Required parameter CreateInlineCommentModel was null or undefined when calling createInlineComment.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<CreateInlineComment201Response>(`${this.basePath}/inline-comments`,
                    CreateInlineCommentModel,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...createInlineCommentOpts?.config,
                        headers: {...headers, ...createInlineCommentOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public deleteFooterComment(comment_id: number, deleteFooterCommentOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public deleteFooterComment(comment_id: number, deleteFooterCommentOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (comment_id === null || comment_id === undefined) {
            throw new Error('Required parameter comment_id was null or undefined when calling deleteFooterComment.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.delete<any>(`${this.basePath}/footer-comments/${encodeURIComponent(String(comment_id))}`,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...deleteFooterCommentOpts?.config,
                        headers: {...headers, ...deleteFooterCommentOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public deleteInlineComment(comment_id: number, deleteInlineCommentOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public deleteInlineComment(comment_id: number, deleteInlineCommentOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (comment_id === null || comment_id === undefined) {
            throw new Error('Required parameter comment_id was null or undefined when calling deleteInlineComment.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.delete<any>(`${this.basePath}/inline-comments/${encodeURIComponent(String(comment_id))}`,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...deleteInlineCommentOpts?.config,
                        headers: {...headers, ...deleteInlineCommentOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getAttachmentComments(id: string, body_format?: PrimaryBodyRepresentation, cursor?: string, limit?: number, sort?: CommentSortOrder, version?: number, getAttachmentCommentsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultAttachmentCommentModel>>;
    public getAttachmentComments(id: string, body_format?: PrimaryBodyRepresentation, cursor?: string, limit?: number, sort?: CommentSortOrder, version?: number, getAttachmentCommentsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getAttachmentComments.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultAttachmentCommentModel>(`${this.basePath}/attachments/${encodeURIComponent(String(id))}/footer-comments`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getAttachmentCommentsOpts?.config,
                        headers: {...headers, ...getAttachmentCommentsOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getBlogPostFooterComments(id: number, body_format?: PrimaryBodyRepresentation, status?: Array<'current' | 'deleted' | 'trashed' | 'historical' | 'draft'>, sort?: CommentSortOrder, cursor?: string, limit?: number, getBlogPostFooterCommentsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultBlogPostCommentModel>>;
    public getBlogPostFooterComments(id: number, body_format?: PrimaryBodyRepresentation, status?: Array<'current' | 'deleted' | 'trashed' | 'historical' | 'draft'>, sort?: CommentSortOrder, cursor?: string, limit?: number, getBlogPostFooterCommentsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getBlogPostFooterComments.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultBlogPostCommentModel>(`${this.basePath}/blogposts/${encodeURIComponent(String(id))}/footer-comments`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getBlogPostFooterCommentsOpts?.config,
                        headers: {...headers, ...getBlogPostFooterCommentsOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getBlogPostInlineComments(id: number, body_format?: PrimaryBodyRepresentation, status?: Array<'current' | 'deleted' | 'trashed' | 'historical' | 'draft'>, resolution_status?: Array<'resolved' | 'open' | 'dangling' | 'reopened'>, sort?: CommentSortOrder, cursor?: string, limit?: number, getBlogPostInlineCommentsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultBlogPostInlineCommentModel>>;
    public getBlogPostInlineComments(id: number, body_format?: PrimaryBodyRepresentation, status?: Array<'current' | 'deleted' | 'trashed' | 'historical' | 'draft'>, resolution_status?: Array<'resolved' | 'open' | 'dangling' | 'reopened'>, sort?: CommentSortOrder, cursor?: string, limit?: number, getBlogPostInlineCommentsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getBlogPostInlineComments.');
        }
        ...
        if (resolution_status) {
            resolution_status.forEach((element) => {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultBlogPostInlineCommentModel>(`${this.basePath}/blogposts/${encodeURIComponent(String(id))}/inline-comments`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getBlogPostInlineCommentsOpts?.config,
                        headers: {...headers, ...getBlogPostInlineCommentsOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getCustomContentComments(id: number, body_format?: PrimaryBodyRepresentation, cursor?: string, limit?: number, sort?: CommentSortOrder, getCustomContentCommentsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultCustomContentCommentModel>>;
    public getCustomContentComments(id: number, body_format?: PrimaryBodyRepresentation, cursor?: string, limit?: number, sort?: CommentSortOrder, getCustomContentCommentsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getCustomContentComments.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultCustomContentCommentModel>(`${this.basePath}/custom-content/${encodeURIComponent(String(id))}/footer-comments`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getCustomContentCommentsOpts?.config,
                        headers: {...headers, ...getCustomContentCommentsOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getFooterCommentById(comment_id: number, body_format?: PrimaryBodyRepresentationSingle, version?: number, include_properties?: boolean, include_operations?: boolean, include_likes?: boolean, include_versions?: boolean, include_version?: boolean, getFooterCommentByIdOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CreateFooterComment201Response>>;
    public getFooterCommentById(comment_id: number, body_format?: PrimaryBodyRepresentationSingle, version?: number, include_properties?: boolean, include_operations?: boolean, include_likes?: boolean, include_versions?: boolean, include_version?: boolean, getFooterCommentByIdOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (comment_id === null || comment_id === undefined) {
            throw new Error('Required parameter comment_id was null or undefined when calling getFooterCommentById.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<CreateFooterComment201Response>(`${this.basePath}/footer-comments/${encodeURIComponent(String(comment_id))}`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getFooterCommentByIdOpts?.config,
                        headers: {...headers, ...getFooterCommentByIdOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getFooterCommentChildren(id: number, body_format?: PrimaryBodyRepresentation, sort?: CommentSortOrder, cursor?: string, limit?: number, getFooterCommentChildrenOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultChildrenCommentModel>>;
    public getFooterCommentChildren(id: number, body_format?: PrimaryBodyRepresentation, sort?: CommentSortOrder, cursor?: string, limit?: number, getFooterCommentChildrenOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getFooterCommentChildren.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultChildrenCommentModel>(`${this.basePath}/footer-comments/${encodeURIComponent(String(id))}/children`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getFooterCommentChildrenOpts?.config,
                        headers: {...headers, ...getFooterCommentChildrenOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getFooterComments(body_format?: PrimaryBodyRepresentation, sort?: CommentSortOrder, cursor?: string, limit?: number, getFooterCommentsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultFooterCommentModel>>;
    public getFooterComments(body_format?: PrimaryBodyRepresentation, sort?: CommentSortOrder, cursor?: string, limit?: number, getFooterCommentsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        let queryParameters = new URLSearchParams();
        if (body_format !== undefined && body_format !== null) {
            queryParameters.append('body-format', <any>body_format);
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultFooterCommentModel>(`${this.basePath}/footer-comments`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public getInlineCommentById(comment_id: number, body_format?: PrimaryBodyRepresentationSingle, version?: number, include_properties?: boolean, include_operations?: boolean, include_likes?: boolean, include_versions?: boolean, include_version?: boolean, getInlineCommentByIdOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CreateInlineComment201Response>>;
    public getInlineCommentById(comment_id: number, body_format?: PrimaryBodyRepresentationSingle, version?: number, include_properties?: boolean, include_operations?: boolean, include_likes?: boolean, include_versions?: boolean, include_version?: boolean, getInlineCommentByIdOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (comment_id === null || comment_id === undefined) {
            throw new Error('Required parameter comment_id was null or undefined when calling getInlineCommentById.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<CreateInlineComment201Response>(`${this.basePath}/inline-comments/${encodeURIComponent(String(comment_id))}`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getInlineCommentByIdOpts?.config,
                        headers: {...headers, ...getInlineCommentByIdOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getInlineCommentChildren(id: number, body_format?: PrimaryBodyRepresentation, sort?: CommentSortOrder, cursor?: string, limit?: number, getInlineCommentChildrenOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultInlineCommentChildrenModel>>;
    public getInlineCommentChildren(id: number, body_format?: PrimaryBodyRepresentation, sort?: CommentSortOrder, cursor?: string, limit?: number, getInlineCommentChildrenOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getInlineCommentChildren.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultInlineCommentChildrenModel>(`${this.basePath}/inline-comments/${encodeURIComponent(String(id))}/children`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getInlineCommentChildrenOpts?.config,
                        headers: {...headers, ...getInlineCommentChildrenOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getInlineComments(body_format?: PrimaryBodyRepresentation, sort?: CommentSortOrder, cursor?: string, limit?: number, getInlineCommentsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultInlineCommentModel>>;
    public getInlineComments(body_format?: PrimaryBodyRepresentation, sort?: CommentSortOrder, cursor?: string, limit?: number, getInlineCommentsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        let queryParameters = new URLSearchParams();
        if (body_format !== undefined && body_format !== null) {
            queryParameters.append('body-format', <any>body_format);
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultInlineCommentModel>(`${this.basePath}/inline-comments`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public getPageFooterComments(id: number, body_format?: PrimaryBodyRepresentation, status?: Array<'current' | 'archived' | 'trashed' | 'deleted' | 'historical' | 'draft'>, sort?: CommentSortOrder, cursor?: string, limit?: number, getPageFooterCommentsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultPageCommentModel>>;
    public getPageFooterComments(id: number, body_format?: PrimaryBodyRepresentation, status?: Array<'current' | 'archived' | 'trashed' | 'deleted' | 'historical' | 'draft'>, sort?: CommentSortOrder, cursor?: string, limit?: number, getPageFooterCommentsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getPageFooterComments.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultPageCommentModel>(`${this.basePath}/pages/${encodeURIComponent(String(id))}/footer-comments`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getPageFooterCommentsOpts?.config,
                        headers: {...headers, ...getPageFooterCommentsOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getPageInlineComments(id: number, body_format?: PrimaryBodyRepresentation, status?: Array<'current' | 'archived' | 'trashed' | 'deleted' | 'historical' | 'draft'>, resolution_status?: Array<'resolved' | 'open' | 'dangling' | 'reopened'>, sort?: CommentSortOrder, cursor?: string, limit?: number, getPageInlineCommentsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<MultiEntityResultPageInlineCommentModel>>;
    public getPageInlineComments(id: number, body_format?: PrimaryBodyRepresentation, status?: Array<'current' | 'archived' | 'trashed' | 'deleted' | 'historical' | 'draft'>, resolution_status?: Array<'resolved' | 'open' | 'dangling' | 'reopened'>, sort?: CommentSortOrder, cursor?: string, limit?: number, getPageInlineCommentsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getPageInlineComments.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<MultiEntityResultPageInlineCommentModel>(`${this.basePath}/pages/${encodeURIComponent(String(id))}/inline-comments`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getPageInlineCommentsOpts?.config,
                        headers: {...headers, ...getPageInlineCommentsOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public updateFooterComment(comment_id: number, UpdateFooterCommentRequest: UpdateFooterCommentRequest, updateFooterCommentOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<FooterCommentModel>>;
    public updateFooterComment(comment_id: number, UpdateFooterCommentRequest: UpdateFooterCommentRequest, updateFooterCommentOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (comment_id === null || comment_id === undefined) {
            throw new Error('Required parameter comment_id was null or undefined when calling updateFooterComment.');
        }

        if (UpdateFooterCommentRequest === null || UpdateFooterCommentRequest === undefined) {
            throw new Error('Required parameter UpdateFooterCommentRequest was null or undefined when calling updateFooterComment.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.put<FooterCommentModel>(`${this.basePath}/footer-comments/${encodeURIComponent(String(comment_id))}`,
                    UpdateFooterCommentRequest,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...updateFooterCommentOpts?.config,
                        headers: {...headers, ...updateFooterCommentOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public updateInlineComment(comment_id: number, UpdateInlineCommentModel: UpdateInlineCommentModel, updateInlineCommentOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CreateInlineComment201Response>>;
    public updateInlineComment(comment_id: number, UpdateInlineCommentModel: UpdateInlineCommentModel, updateInlineCommentOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (comment_id === null || comment_id === undefined) {
            throw new Error('Required parameter comment_id was null or undefined when calling updateInlineComment.');
        }

        if (UpdateInlineCommentModel === null || UpdateInlineCommentModel === undefined) {
            throw new Error('Required parameter UpdateInlineCommentModel was null or undefined when calling updateInlineComment.');
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.put<CreateInlineComment201Response>(`${this.basePath}/inline-comments/${encodeURIComponent(String(comment_id))}`,
                    UpdateInlineCommentModel,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...updateInlineCommentOpts?.config,
                        headers: {...headers, ...updateInlineCommentOpts?.config?.headers},
                    }
                );
            })
        );
